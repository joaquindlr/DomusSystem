                     ...
                     <tbody> 
                        ...
                        <tr>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" placeholder="17/05/2021" disabled></input>
                         ...
                         <div class="input-group mb-3">
                                    ...
                                    <input type="text" placeholder="Cliente123" disabled></input>
                        ...
                        <tr>  
                         <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">Teléfono Cliente</span>
                        ...
                        <tr>  
                         <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">Propiedad</span>
                                    <input type="text" placeholder="Propiedad 1" disabled></input>
                        ...
                        <tr>  
                         <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">Agente</span>
                                    <input type="text" placeholder="Agente 1" disabled></input>
                        ...
                        <tr>  
                         <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">Tipo Actividad</span>
                                    <input type="text" placeholder="Actividad" disabled></input>
                                
                                    <span class="input-group-text" id="basic-addon1">Estado</span>
                                    <input type="text" placeholder="En Proceso" disabled></input>
