      ...
      {visible && (
        ...
        >
            ...
            <div class="d-grid  col-10 mx-auto">
                <label for="CodProp" className="form-label">Ingresar Codigo de Propiedad</label>
                    <input type="text" className="form-control imput" id="CodProp" placeholder="Codigo de Propiedad"  />
