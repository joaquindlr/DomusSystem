...
const ModalEd = ({ visible, handleVisible }) => {
    ...
    const mensaje1 = () => {
      ...
      {visible && (
        ...
        >
            <>
            <CitaEliminada visible={visiblec} handleVisible={handleVisiblec} />
            ...
            <div class="d-grid  col-10 mx-auto">
                <label for="CodProp" className="form-label">Seleccionar fecha</label>
                    <input type="date" className="form-control imput" id="CodProp"  />
                               ...
                               {Mensaje1 && (
                                 ...
                                 <p>
                                    ...
                                    <table className="table  table-bordered  ">
                                        <thead>
                                           <tr>
                                              <th scope="col" colSpan="8" class="table-dark"
                                              >
                                        ...
                                        <tbody> 
                                            ...
                                            <tr>
                                                <td ><select id="inputDate" class="form-select">
                                                            <option selected>20/05/21</option>
                                                            <option>22/05/21</option>
                                                    </select>
                                                </td>
                                                
                                                    <td><select id="inputTime" class="form-select">
                                                 ...
                                                 <td>----</td>
                                                 <td>----</td>
                                                 <td><select id="input" class="form-select">
                                                 ...
                                                 <td><button class="btn btn-outline-danger" type="button" onClick={() => setVisiblec(true)}>
                                                       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                                                          <path d="M1.293 1.293a1 1 0 0 1 1.414 0L8 6.586l5.293-5.293a1 1 0 1 1 1.414 1.414L9.414 8l5.293 5.293a1 1 0 0 1-1.414 1.414L8 9.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L6.586 8 1.293 2.707a1 1 0 0 1 0-1.414z"/>
                                                        </svg>
                                                    </button>
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                 <button class="btn btn-outline-success" type="button" onClick={() => handleVisible(false)}
                 >Confirmar
