      ...
      <div class="container">
        <div class="row">
          <div class="col-auto">
            ...
            <label for="CodCli" class="form-label">
            ...
            <br></br>
            <label for="CodProp" class="form-label">
            ...
            <div class="col ">
              <th>
                ...
                <input type="time" class="form-control" id="HoraIn"></input>
              </th>
              ...
              <th>
                ...
                <input type="time" class="form-control" id="HoraFin"></input>
              </th>
            </div>
            <br></br>
            <div class="col ">
